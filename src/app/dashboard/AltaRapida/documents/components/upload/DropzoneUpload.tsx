  ...
  return (
    <div className="space-y-1.5">
      ...
      <div
        ...
        onDrop={handleDrop}
        className={cn(
          "w-full min-h-22.5 rounded-lg border border-border bg-card flex flex-col items-center justify-center text-center transition-all cursor-pointer relative",
